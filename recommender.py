...
class Recommender:
    ...
    def fit_transform(self, review_file, recipe_file, review_type):
        self.transformer_review.fit_raw_data(review_file,review_type)
    ...
    def generator(self, recipe_id):
        ...
        ranking_df = pd.concat([recipe_df, name_df, tag_df, ingre_df], join="outer", axis=1)
